Feature: Add a new Rating entry

    As a blogger
    So that I can contribute to others blogs
    I want to be able to be rate articles 
    
Scenario: As a blogger I want to be able to navigate from the homepage to the new rating form
